...
string database::getValue(int row, int column){
    return databaseVector[row][column];
}
...
void database::printTable() {
    ...
    for(unsigned int i = 0; i < databaseVector.size(); i++){
        cout << databaseVector[i][0] << '|' << databaseVector[i][1] << endl;
    }
}
...
void database::writeToFile() {
    ...
    for (unsigned int i = 0; i < databaseVector.size(); i++){
        fout << databaseVector[i][0] << '|' << databaseVector[i][1] << endl;
    }
